...
class DisputeControllerTest {
    ...
    @MockitoBean
    private ListDisputesUseCase listDisputesUseCase;
    ...
    void listDisputes_asCustomer_200() throws Exception {
        ...
        when(listDisputesUseCase.listDisputes(eq(customerId), eq(false))).thenReturn(List.of());
    ...
    void createDispute_authenticated_201() throws Exception {
        ...
        UserPrincipal principal = new UserPrincipal(customerId, "customer@example.com", AppRole.CUSTOMER);
        when(createDisputeUseCase.createDispute(any())).thenReturn(dispute(disputeId, customerId));
    ...
    void resolveDispute_asStaff_200() throws Exception {
        ...
        when(resolveDisputeUseCase.resolveDispute(eq(disputeId), any()))
