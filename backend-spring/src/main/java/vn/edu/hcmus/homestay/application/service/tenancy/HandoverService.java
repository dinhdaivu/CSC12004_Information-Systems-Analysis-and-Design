...
import vn.edu.hcmus.homestay.application.port.in.tenancy.CreateHandoverUseCase;
import vn.edu.hcmus.homestay.application.port.in.tenancy.GetHandoverUseCase;
import vn.edu.hcmus.homestay.application.port.in.tenancy.UpdateHandoverUseCase;
...
public class HandoverService implements CreateHandoverUseCase, GetHandoverUseCase, UpdateHandoverUseCase {
    ...
    @Override
    @Transactional
    public HandoverDetailView createHandover(CreateHandoverCommand command) {
    ...
    @Override
    public HandoverDetailView getHandover(UUID id) {
    ...
    @Override
    @Transactional
    public HandoverDetailView completeHandover(UUID id) {
        Handover handover = loadHandoverPort.loadById(id)
                .orElseThrow(() -> new NotFoundException("Handover not found"));
        Contract contract = loadContractPort.loadById(handover.getContractId())
                .orElseThrow(() -> new NotFoundException("Contract not found"));
    ...
    @Override
    @Transactional
    public HandoverDetailView cancelHandover(UUID id) {
        Handover handover = loadHandoverPort.loadById(id)
                .orElseThrow(() -> new NotFoundException("Handover not found"));
        Contract contract = loadContractPort.loadById(handover.getContractId())
                .orElseThrow(() -> new NotFoundException("Contract not found"));
    ...
    @Override
    @Transactional
    public HandoverDetailView signHandover(UUID id, SignHandoverCommand command) {
        Handover handover = loadHandoverPort.loadById(id)
                .orElseThrow(() -> new NotFoundException("Handover not found"));
        Contract contract = loadContractPort.loadById(handover.getContractId())
                .orElseThrow(() -> new NotFoundException("Contract not found"));
    ...
    @Override
    @Transactional
    public HandoverDetailView addHandoverItem(UUID handoverId, CreateHandoverUseCase.HandoverItemCommand item) {
    ...
    private HandoverDetailView buildAggregate(Handover handover, Contract contract) {
