...
import vn.edu.hcmus.homestay.application.port.out.LoadInspectionPort;
import vn.edu.hcmus.homestay.application.port.out.SaveInspectionPort;
...
@Service
public class InspectionService implements ManageInspectionUseCase {
    ...
    @Override
    @Transactional
    public CheckoutInspection createInspection(UUID checkoutRequestId, CreateInspectionCommand cmd) {
