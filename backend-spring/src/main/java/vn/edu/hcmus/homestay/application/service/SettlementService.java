...
@Service
public class SettlementService implements ManageSettlementUseCase {
    ...
    @Override
    @Transactional
    public Settlement createSettlement(UUID checkoutRequestId, CreateSettlementCommand cmd) {
