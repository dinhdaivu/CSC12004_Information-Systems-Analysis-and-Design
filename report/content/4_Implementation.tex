...
Các lựa chọn triển khai trong chương này bám theo tài liệu chính thức của Angular,
Express, TypeScript và Supabase để bảo đảm tính nhất quán giữa frontend, backend
và tầng dữ liệu \cite{angular_docs,express_docs,typescript_docs,supabase_docs}.
